...
@Component({
  selector: 'grade-details-panel',
  templateUrl: './grade-details-panel.component.html',
  styleUrl: './grade-details-panel.component.scss'
})
export class GradeDetailsPanelComponent implements OnInit {
  listOfData: any[] = [];
  date = null;
